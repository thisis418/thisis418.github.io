import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{m as i,n as m,o as a,p as r,v as wr,q as o,r as x,w as Ar}from"../chunks/vUuJ8Ryo.js";import{T as Rr}from"../chunks/DqnZMk7a.js";import{P as C}from"../chunks/9ERiZpYr.js";import{P as f}from"../chunks/Bmbs4jhX.js";import{M as e}from"../chunks/BLaOouyV.js";import{C as D}from"../chunks/DgQHwt6I.js";import{S as T}from"../chunks/CZSxeg5_.js";import{C as F}from"../chunks/DYLuZg8q.js";import{L as Hr}from"../chunks/BkpsGtL-.js";import{E as H}from"../chunks/ZgqWhDbx.js";import{L as E}from"../chunks/Dhcn_In5.js";import{I as zr}from"../chunks/C1QHWWJM.js";import{F as Or}from"../chunks/w7QeE_JE.js";import{H as O}from"../chunks/C4cVQCIn.js";import{C as I}from"../chunks/BRn_OWn-.js";import{E as Jr,a as Nr}from"../chunks/8Ku7iipy.js";const Qr=""+new URL("../assets/binary-search-decision-tree.DaCgUG4n.svg",import.meta.url).href;var Vr=i("<!> <!> <!> <!> <!> <!>",1),Wr=i("<!> <!> <!> <!>",1),Xr=i(`Давайте представим, что мы ищем слово в словаре.
    ...
    На последнем уровне <!> элементов.`,1),Fo=i(`Подставляем это в формулу <!>,
    считаем и получаем`,1),Eo=i("<!> <!> <!> <!> <!>",1),Io=i(`Максимальная оценка количества сравнений &mdash; количество уровней в дереве, <!>.
        А <!>,
    ...
    Но сейчас мы формализуем это наше действо, проанализируем алгоритм и поймем, что он очень эффективный.`);a(v,t)}}),a(p,d)}});var z=r(R,2);C(z,{children:(p,K)=>{var d=oo(),h=m(d);f(h,{children:(s,v)=>{o();var n=Zr(),t=r(m(n));e(t,{m:"K_1, K_2, K_3, \\dotsc, K_{n-1}, K_n"}),o(),a(s,n)}});var $=r(h,2);e($,{display:!0,m:"K_1 < K_2 < K_3 < \\dotsb < K_{n-1} < K_n"});var c=r($,2);f(c,{children:(s,v)=>{o();var n=ro(),t=r(m(n));e(t,{m:"K"});var _=r(t,2);e(_,{m:"j"});var l=r(_,2);e(l,{m:"K_j = K"}),o(),a(s,n)}}),a(p,d)}});var J=r(z,2);C(J,{children:(p,K)=>{f(p,{children:(d,h)=>{o();var $=eo(),c=r(m($));e(c,{m:"i"});var s=r(c,2);e(s,{m:"K_i"});var v=r(s,2);e(v,{m:"K_i"});var n=r(v,2);e(n,{m:"K"}),o(),a(d,$)}})}});var N=r(J,2);H(N,{children:(p,K)=>{var d=_o(),h=m(d);E(h,{children:(s,v)=>{var n=ao(),t=m(n);e(t,{m:"K_i < K"});var _=r(t,2);e(_,{m:"i"}),o(),a(s,n)}});var $=r(h,2);E($,{children:(s,v)=>{var n=no(),t=m(n);e(t,{m:"K_i = K"}),o(),a(s,n)}});var c=r($,2);E(c,{children:(s,v)=>{var n=to(),t=m(n);e(t,{m:"K_i > K"});var _=r(t,2);e(_,{m:"i"}),o(),a(s,n)}}),a(p,d)}});var Q=r(N,2);C(Q,{children:(p,K)=>{f(p,{children:(d,h)=>{o();var $=vo();o(2),a(d,$)}})}});var V=r(Q,2);C(V,{children:(p,K)=>{var d=so(),h=m(d);f(h,{children:(s,v)=>{o();var n=x("Перед тем, как превратить наше рукомахание в рабочий код, надо провести некоторые манипуляции.");a(s,n)}});var $=r(h,2);f($,{children:(s,v)=>{o();var n=lo(),t=r(m(n));F(t,{c:"left"});var _=r(t,2);F(_,{c:"right"});var l=r(_,2);e(l,{m:"\\code{left} = 0"});var g=r(l,2);e(g,{m:"\\code{right} = n - 1"});var u=r(g,2);e(u,{m:"\\code{middle} = \\lfloor (\\code{left} + \\code{right}) / 2 \\rfloor"});var P=r(u,2);e(P,{m:"K_{\\code{middle}}"}),o(),a(s,n)}});var c=r($,2);f(c,{children:(s,v)=>{o();var n=x(`Все действия будем делать до тех пор, пока в границе поиска не останется один элемент.
    ...
    return not found`});var X=r(W,2);C(X,{children:(p,K)=>{f(p,{children:(d,h)=>{o();var $=io(),c=r(m($));e(c,{m:"O(\\log n)"}),o(),a(d,$)}})}});var Y=r(X,2);C(Y,{children:(p,K)=>{f(p,{children:(d,h)=>{o();var $=mo(),c=r(m($),3);F(c,{c:"left"});var s=r(c,2);F(s,{c:"right"});var v=r(s,2);F(v,{c:"i"});var n=r(v,2);F(n,{c:"m"}),o(),a(d,$)}})}});var Z=r(Y,2);D(Z,{code:`
...
`});var ar=r(er,2);T(ar,{anchor:"binary-search-in-array-analysis",children:(p,K)=>{o();var d=x("Анализ алгоритма");a(p,d)}});var nr=r(ar,2);C(nr,{children:(p,K)=>{var d=xo(),h=m(d);f(h,{children:(c,s)=>{o();var v=x("Давайте поподробнее проанализируем алгоритм и его время работы.");a(c,v)}});var $=r(h,2);f($,{children:(c,s)=>{o();var v=uo(),n=r(m(v));e(n,{m:"15"}),o(),a(c,v)}}),a(p,d)}});var tr=r(nr,2);zr(tr,{get src(){return Qr}});var _r=r(tr,2);C(_r,{children:(p,K)=>{var d=jo(),h=m(d);f(h,{children:(s,v)=>{o();var n=bo(),t=r(m(n));e(t,{m:"K"}),o(),a(s,n)}});var $=r(h,2);f($,{children:(s,v)=>{o();var n=Ko(),t=r(m(n));e(t,{m:"\\lfloor \\log_2 n \\rfloor + 1"});var _=r(t,2);e(_,{m:"1"}),o(),a(s,n)}});var c=r($,2);f(c,{children:(s,v)=>{o();var n=qo(),t=r(m(n));e(t,{m:"C"});var _=r(t,2);e(_,{m:"2^{k-1} \\le n < 2^k"});var l=r(_,2);e(l,{m:"1"});var g=r(l,2);e(g,{m:"k"});var u=r(g,2);e(u,{m:"2^{k-1} \\le n < 2^k - 1"});var P=r(u,2);e(P,{m:"k-1"});var k=r(P,2);e(k,{m:"k"}),o(),a(s,n)}}),a(p,d)}});var dr=r(_r,2);Or(dr,{title:"Распределение аргументов поиска",children:(p,K)=>{var d=yo(),h=m(d);f(h,{children:(c,s)=>{o();var v=x(`Структура массива (и, как следствие, дерева решений) у нас фиксированная.
    ...
    Поэтому в начале придётся совершить некоторые подготовительные действия.`);a(n,_)}});var c=r($,2);f(c,{children:(n,t)=>{o();var _=Bo(),l=r(m(_));e(l,{m:"m \\ge 0"});var g=r(l,2);e(g,{m:"n + m"});var u=r(g,2);e(u,{m:"1"});var P=r(u,2);e(P,{m:"n + m = F_{k+1} - 1"}),o(),a(n,_)}});var s=r(c,2);f(s,{children:(n,t)=>{o();var _=So(),l=r(m(_));e(l,{m:"j = F_k - m"});var g=r(l,2);e(g,{m:"p"});var u=r(g,2);e(u,{m:"q"});var P=r(u,2);e(P,{m:"p = F_{k-1}"});var k=r(P,2);e(k,{m:"q = F_{k-2}"}),o(),a(n,_)}});var v=r(s,2);f(v,{children:(n,t)=>{o();var _=Mo(),l=r(m(_));e(l,{m:"4"}),o(),a(n,_)}}),a(p,d)}});var hr=r(pr,2);H(hr,{children:(p,K)=>{var d=No(),h=m(d);E(h,{children:(v,n)=>{f(v,{children:(t,_)=>{var l=Go(),g=m(l);e(g,{m:"j \\le 0"});var u=r(g,2);e(u,{m:"j + q"});var P=r(u,2);F(P,{c:"p = p - q"});var k=r(P,2);F(k,{c:"q = q - p"}),o(),a(t,l)}})}});var $=r(h,2);E($,{children:(v,n)=>{f(v,{children:(t,_)=>{var l=Ro(),g=m(l);e(g,{m:"K_i > K"});var u=r(g,2);e(u,{m:"j - q"});var P=r(u,2);F(P,{c:"(p, q) = (q, p - q)"}),o(),a(t,l)}})}});var c=r($,2);E(c,{children:(v,n)=>{f(v,{children:(t,_)=>{var l=zo(),g=m(l);e(g,{m:"K_j < K"});var u=r(g,2);e(u,{m:"j + q"});var P=r(u,2);F(P,{c:"p = p - q"});var k=r(P,2);F(k,{c:"q = q - p"}),o(),a(t,l)}})}});var s=r(c,2);E(s,{children:(v,n)=>{f(v,{children:(t,_)=>{var l=Jo(),g=m(l);e(g,{m:"K_i = K"}),o(),a(t,l)}})}}),a(p,d)}});var gr=r(hr,2);C(gr,{children:(p,K)=>{f(p,{children:(d,h)=>{o();var $=Qo(),c=r(m($));e(c,{m:"q = 0"});var s=r(c,2);e(s,{m:"p = 1"}),o(),a(d,$)}})}});var Pr=r(gr,2);D(Pr,{code:`
...
`});var jr=r(qr,2);C(jr,{children:(p,K)=>{var d=se(),h=m(d);f(h,{children:(n,t)=>{o();var _=ve(),l=r(m(_));e(l,{m:"C(n)"});var g=r(l,2);e(g,{m:"n"}),o(),a(n,_)}});var $=r(h,2);e($,{display:!0,m:"C(1) = 0 \\qquad\\text{и}\\qquad C(n) \\approx 1 + p \\cdot C(pn) + q \\cdot C(qn) \\quad\\text{для}~ n > 1"});var c=r($,2);f(c,{children:(n,t)=>{o();var _=le(),l=r(m(_));e(l,{m:"n"});var g=r(l,2);e(g,{m:"p"});var u=r(g,2);e(u,{m:"pn"});var P=r(u,2);e(P,{m:"q"});var k=r(P,2);e(k,{m:"qn"}),o(),a(n,_)}});var s=r(c,2);f(s,{children:(n,t)=>{o();var _=x("Из этой рекурсивной формулы получаем, что");a(n,_)}});var v=r(s,2);e(v,{display:!0,m:"C \\approx \\log_{p^{-p} \\, q^{-q}} n = - \\frac{\\log n}{p \\log p + q \\log q}"}),a(p,d)}});var Sr=r(jr,2);C(Sr,{children:(p,K)=>{var d=ge(),h=m(d);f(h,{children:(P,k)=>{o();var b=x("В знаменателе получилась такая интересная формула не случайно.");a(P,b)}});var $=r(h,2);f($,{children:(P,k)=>{o();var b=ie(),j=r(m(b));e(j,{m:"2"});var q=r(j,2);e(q,{m:"m"});var L=r(q,2);e(L,{m:"p_1, p_2, \\dotsc, p_m"});var y=r(L,2);e(y,{m:"p_1 + p_2 + \\dotsb + p_m = 1"}),o(),a(P,b)}});var c=r($,2);f(c,{children:(P,k)=>{o();var b=me(),j=r(m(b));e(j,{m:"m-1"}),o(),a(P,b)}});var s=r(c,2);f(s,{children:(P,k)=>{o();var b=$e(),j=r(m(b));e(j,{m:"C(n)"});var q=r(j,2);e(q,{m:"n"}),o(),a(P,b)}});var v=r(s,2);e(v,{display:!0,m:"C(1) = 0 \\qquad\\text{и}\\qquad C(n) \\approx (m-1) + p_1 \\cdot C(p_1 n) + p_2 \\cdot C(p_2 n) + \\dotsc + p_m \\cdot C(p_m n) \\quad\\text{для}~ n > 1"});var n=r(v,2);f(n,{children:(P,k)=>{o();var b=ce(),j=r(m(b));e(j,{m:"m = 2"});var q=r(j,2);e(q,{m:"p_j"});var L=r(q,2);e(L,{m:"j"});var y=r(L,2);e(y,{m:"p_j n"}),o(),a(P,b)}});var t=r(n,2);f(t,{children:(P,k)=>{o();var b=fe(),j=r(m(b));e(j,{m:"m-1"});var q=r(j,2);e(q,{m:"m-1"});var L=r(q,2);e(L,{m:"K"}),o(),a(P,b)}});var _=r(t,2);f(_,{children:(P,k)=>{o();var b=x("Решая рекуррентное соотношение, получаем");a(P,b)}});var l=r(_,2);e(l,{display:!0,m:"C(n) \\approx (k-1) \\cdot \\frac{\\log n}{\\H}"});var g=r(l,2);f(g,{children:(P,k)=>{o();var b=pe(),j=r(m(b));e(j,{m:"\\H = - \\sum_{j=1}^m p_j \\log p_j"});var q=r(j,2);e(q,{m:"p_1, p_2, \\dotsc, p_m"}),o(),a(P,b)}});var u=r(g,2);f(u,{children:(P,k)=>{o();var b=he(),j=r(m(b));e(j,{m:"\\log n"});var q=r(j,2);e(q,{m:"n"});var L=r(q,2);e(L,{m:"\\H"});var y=r(L,2);e(y,{m:"m-1"}),o(),a(P,b)}}),a(p,d)}}),Ar(w);var A=r(w,2),yr=wr(A);O(yr,{anchor:"interpolation-search",children:(p,K)=>{o();var d=x("Интерполяционный поиск");a(p,d)}});var kr=r(yr,2);C(kr,{children:(p,K)=>{var d=Pe(),h=m(d);f(h,{children:(c,s)=>{o();var v=x(`Давайте снова возьмем словарь и будем искать в нйм слова.
    ...
    return not found`});var Er=r(Fr,2);T(Er,{children:(p,K)=>{o();var d=x("Анализ количества сравнений");a(p,d)}});var Mr=r(Er,2);C(Mr,{children:(p,K)=>{f(p,{children:(d,h)=>{o();var $=ye(),c=r(m($));e(c,{m:"O(\\log \\log n)"}),o(),a(d,$)}})}}),Ar(A);var Ir=r(A,2);O(Ir,{anchor:"exercises",children:(p,K)=>{o();var d=x("Упражнения");a(p,d)}});var Ur=r(Ir,2);Jr(Ur,{children:(p,K)=>{Nr(p,{number:1,difficulty:"medium",children:(d,h)=>{var $=Ie(),c=m($);C(c,{children:(v,n)=>{var t=Le(),_=m(t);f(_,{children:(g,u)=>{var P=ke();o(),a(g,P)}});var l=r(_,2);f(l,{children:(g,u)=>{o();var P=Ce(),k=r(m(P));F(k,{c:"a"});var b=r(k,2);e(b,{m:"n"});var j=r(b,2);e(j,{m:"t"}),o(),a(g,P)}}),a(v,t)}});var s=r(c,2);H(s,{children:(v,n)=>{var t=Ee(),_=m(t);E(_,{children:(b,j)=>{f(b,{children:(q,L)=>{o();var y=x("Отсортированный по возрастанию массив был циклически сдвинут.");a(q,y)}})}});var l=r(_,2);E(l,{children:(b,j)=>{f(b,{children:(q,L)=>{o();var y=x("В отсортированном по возрастанию массиве поменяли местами два случайных элемента.");a(q,y)}})}});var g=r(l,2);E(g,{children:(b,j)=>{f(b,{children:(q,L)=>{o();var y=x("К отсортированному по возрастанию массиву приписали отсортированный по убыванию.");a(q,y)}})}});var u=r(g,2);E(u,{children:(b,j)=>{f(b,{children:(q,L)=>{o();var y=x("Склеили два отсортированных по возрастанию массива.");a(q,y)}})}});var P=r(u,2);E(P,{children:(b,j)=>{f(b,{children:(q,L)=>{o();var y=x(`К отсортированному по возрастанию массиву приписали отсортированный по убыванию.
    Получившийся массив циклически сдвинули.`);a(q,y)}})}});var k=r(P,2);E(k,{children:(b,j)=>{f(b,{children:(q,L)=>{o();var y=Fe(),Tr=r(m(y));F(Tr,{c:"none"});var Dr=r(Tr,2);F(Dr,{c:"none"});var Gr=r(Dr,2);F(Gr,{c:"none"}),o(),a(q,y)}})}}),a(v,t)}}),a(d,$)}})}}),a(Br,B)}export{Ye as component};
