import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{m as _,n as t,o as e,p as r,q as o,r as g}from"../chunks/vUuJ8Ryo.js";import{I as vr}from"../chunks/C1QHWWJM.js";import{P as v}from"../chunks/Bmbs4jhX.js";import{T as hr}from"../chunks/DqnZMk7a.js";import{M as l}from"../chunks/BLaOouyV.js";import{S as dr}from"../chunks/CZSxeg5_.js";import{C as j}from"../chunks/DgQHwt6I.js";import{C as D}from"../chunks/DYLuZg8q.js";import{E as sr}from"../chunks/ZgqWhDbx.js";import{L as S}from"../chunks/Dhcn_In5.js";import{P as C}from"../chunks/9ERiZpYr.js";import{P as fr}from"../chunks/yslk_owi.js";import{H as gr}from"../chunks/C4cVQCIn.js";import{E as cr,a as pr}from"../chunks/8Ku7iipy.js";const $r=""+new URL("../assets/skip-list.Dsdec6ik.svg",import.meta.url).href,ur=""+new URL("../assets/skip-list-insertion.Bd-NDEGq.svg",import.meta.url).href;var Pr=_(`Список с пропусками (skip list) &mdash; вероятностная структура данных,
    ...
    Теперь можно посчитать вероятности`,1),jr=_("<!> <!> <!> <!> <!> <!>",1),qr=_("<!> <!> <!> <!>",1),Dr=_("<!> <!> <!> <!> <!>",1),Mr=_(`Первому, низшему уровню соответствует индекс <!>. Длина
    ...
    свидетельствует о максимальной высоте списка.`,1),Rr=_("Все узлы списка с пропусками можно обернуть в один тип <!>, хранящий первый узел.",1),Ur=_("Нужно найти первый элемент, значение которого не меньше данного <!>.",1),Gr=_("Переместимся на уровень ниже и перейдем к шагу <!>.",1),Nr=_("<!> <!> <!>",1),Or=_(`Во время поиска мы на каждом уровне нашли узел, который не
...
меньше искомого.`);e(c,d)}});var L=r(T,2);S(L,{children:(c,k)=>{o();var d=Gr(),b=r(t(d));l(b,{m:"2"}),o(),e(c,d)}}),e(a,n)}});var Y=r(X,2);j(Y,{code:`method find(skiplist self, value):
    ...
    return current.next[0]`});var Z=r(Y,2);v(Z,{children:(a,H)=>{o();var n=Or(),p=r(t(n));D(p,{c:"value"}),o(),e(a,n)}});var rr=r(Z,2);j(rr,{code:`method find_path(skiplist self, value):
    current = self.first
    height = length of current.next
