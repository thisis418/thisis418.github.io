import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{m as c,n as $,o as _,p as r,q as e,r as g}from"../chunks/vUuJ8Ryo.js";import{T as vr}from"../chunks/DqnZMk7a.js";import{P as k}from"../chunks/9ERiZpYr.js";import{P as m}from"../chunks/Bmbs4jhX.js";import{M as n}from"../chunks/BLaOouyV.js";import{C as w}from"../chunks/DgQHwt6I.js";import{H as L}from"../chunks/C4cVQCIn.js";import{S as M}from"../chunks/CZSxeg5_.js";import"../chunks/BQ0lqLUb.js";/* empty css                *//* empty css                *//* empty css                *//* empty css                */import{I as sr}from"../chunks/C1QHWWJM.js";/* empty css                */const ir=""+new URL("../assets/trie-example.lh90TSUK.svg",import.meta.url).href;var mr=c("<!> <!>",1),lr=c(`<b>Задача лучевого поиска.</b> Есть алфавит <!> размера <!>.
        ...
        можно предварительно отсортировать ключи, а в ассоциативный массиве брать ссылки по ключам в этом порядке.`,1),qr=c("<!> <!>",1),Or=c(`Возьмем алфавит из чисел <!>.
        Тогда можно взять язык <!>.
        На самом деле это просто по-умному записанная фраза
        &laquo;представим все числа в системе счисления по основанию <!> и будем рассматривать их как строки над алфавитом <!>&raquo;.`,1),Rr=c(`Теперь бор может хранить натуральные числа.
        Во время вставки, удаления и поиска числа <!> нам нужно сделать <!> переходов по ассоциированным ссылкам.
        Получается, эти операции работают за время <!>.`,1),Wr=c("<!> <!>",1),Cr=c(`Разберем подробнее двоичную систему счисления, <!>.
        Бор здесь превращается в бинарное дерево:
        левому ребенку соответствует цифра <!>, а правому <!>.`,1),Hr=c("<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>",1);function ro(er){var T=Hr(),q=$(T);vr(q,{title:"Бор"});var O=r(q,2);k(O,{children:(d,p)=>{var a=mr(),i=$(a);m(i,{children:(t,s)=>{e();var o=g(`Обратимся снова к поиску слова в словаре.
        ...
        Задача поиска данных описанным методом называется лучевым поиском.`);_(t,o)}}),_(d,a)}});var R=r(O,2);k(R,{children:(d,p)=>{m(d,{children:(a,i)=>{var v=lr(),t=r($(v),2);n(t,{m:"\\Sigma"});var s=r(t,2);n(s,{m:"\\sigma"});var o=r(s,2);n(o,{m:"K_i \\in \\Sigma^*"});var l=r(o,2);n(l,{m:"R_i"});var h=r(l,2);n(h,{m:"K_i"});var P=r(h,2);n(P,{m:"R_i"}),e(),_(a,v)}})}});var W=r(R,2);k(W,{children:(d,p)=>{var a=cr(),i=$(a);m(i,{children:(t,s)=>{e();var o=g("Будем действовать точно так же, как в тех книжках с буквенными метками. Сделаем бор.");_(t,o)}});var v=r(i,2);m(v,{children:(t,s)=>{e();var o=$r(),l=r($(o));n(l,{m:"\\Sigma"}),e(),_(t,o)}}),_(d,a)}});var C=r(W,2);k(C,{children:(d,p)=>{m(d,{children:(a,i)=>{e();var v=g(`Вот пример бора, построенного для слов
    ...
    save some additional data at root`});var J=r(G,2);L(J,{children:(d,p)=>{e();var a=g("Анализ строк");_(d,a)}});var Q=r(J,2);k(Q,{children:(d,p)=>{m(d,{children:(a,i)=>{e();var v=ur(),t=r($(v));n(t,{m:"\\Sigma"});var s=r(t,2);n(s,{m:"\\sigma"});var o=r(s,2);n(o,{m:"n"}),e(),_(a,v)}})}});var V=r(Q,2);M(V,{children:(d,p)=>{e();var a=g("Количество ветвящихся узлов");_(d,a)}});var X=r(V,2);k(X,{children:(d,p)=>{var a=Mr(),i=$(a);m(i,{children:(x,S)=>{e();var f=g(`Каждый узел бора соответствует уникальному префиксу какой-то строки.
        ...
        обычные человеческие слова очень часто приходится сортировать в лексикографическом порядке.`);_(t,o)}}),_(d,a)}});var rr=r(Z,2);k(rr,{children:(d,p)=>{var a=qr(),i=$(a);m(i,{children:(t,s)=>{e();var o=Tr(),l=r($(o));n(l,{m:"\\Sigma"}),e(),_(t,o)}});var v=r(i,2);m(v,{children:(t,s)=>{e();var o=g(`Поместим все строки, которые мы хотим отсортировать, в бор.
        А дальше просто рекурсивно ходим по бору в соответствии с заданным порядком.`);_(t,o)}}),_(d,a)}});var or=r(rr,2);L(or,{children:(d,p)=>{e();var a=g("Цифровой бор");_(d,a)}});var ar=r(or,2);k(ar,{children:(d,p)=>{var a=Wr(),i=$(a);m(i,{children:(t,s)=>{e();var o=Or(),l=r($(o));n(l,{m:"W = \\{0, 1, 2, \\dotsc, w\\}"});var h=r(l,2);n(h,{m:"W^+ = \\NN"});var P=r(h,2);n(P,{m:"w"});var y=r(P,2);n(y,{m:"W"}),e(),_(t,o)}});var v=r(i,2);m(v,{children:(t,s)=>{e();var o=Rr(),l=r($(o));n(l,{m:"n"});var h=r(l,2);n(h,{m:"\\log_w n"});var P=r(h,2);n(P,{m:"O(\\log_w n)"}),e(),_(t,o)}}),_(d,a)}});var tr=r(ar,2);k(tr,{children:(d,p)=>{m(d,{children:(a,i)=>{e();var v=Cr(),t=r($(v));n(t,{m:"w = 2"});var s=r(t,2);n(s,{m:"0"});var o=r(s,2);n(o,{m:"1"}),e(),_(a,v)}})}}),_(er,T)}export{ro as component};
