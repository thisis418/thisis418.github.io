import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{m as c,n as l,o as t,p as r,q as e,r as R}from"../chunks/BEXab77u.js";import{T as nr}from"../chunks/CMyx6b9d.js";import{P as b}from"../chunks/M3lTRSDe.js";import{P as p}from"../chunks/C_D4TOu8.js";/* empty css                *//* empty css                */import{S as C}from"../chunks/Dck_Hiah.js";import{C as y}from"../chunks/BrnW0Io5.js";import{C as q}from"../chunks/DPRrKhiz.js";import{H as rr}from"../chunks/u75EwaVn.js";import{M as o}from"../chunks/BTDwyb5B.js";/* empty css                *//* empty css                *//* empty css                */var tr=c(`Вместо работы с числами в обычном виде <!>, Питер Монтгомери предложил
    ...
    а на почти произвольное число <!>.`,1),xr=c(`Мы можем выбрать <!> удобным для себя. Например, степень двойки!
    Деление на степень двойки можно реализовать через сдвиг, а взятие по модулю реализовывать вообще не нужно,
    если подобрать правильный тип данных.`,1),fr=c("Итого мы получаем очень эффективный и быстрый код. Здесь я взял <!>.",1),gr=c("<!> <!> <!>",1),hr=c(`Если мы можем позволить себе вернуть число в диапазоне от <!> до <!>,
    ...
    Эта операция очень дорогая — целых 15–30 тактов.`);t(n,i)}})}});var j=r(T,2);b(j,{children:(_,h)=>{var n=_r(),M=l(n);p(M,{children:(a,d)=>{e();var v=tr(),s=r(l(v));o(s,{m:"a \\bmod M"}),e(3),t(a,v)}});var i=r(M,2);p(i,{children:(a,d)=>{e();var v=dr(),s=r(l(v));o(s,{m:"M"});var f=r(s,2);o(f,{m:"R"});var $=r(f,2);o($,{m:"M"});var g=r($,2);o(g,{m:"R \\rprime M"}),e(),t(a,v)}});var x=r(i,2);p(x,{children:(a,d)=>{e();var v=vr(),s=r(l(v));o(s,{m:"x"}),e(),t(a,v)}});var m=r(x,2);o(m,{display:!0,m:"\\overline{x} = x \\cdot R \\bmod M"});var u=r(m,2);p(u,{children:(a,d)=>{e();var v=R(`Для того, чтобы вычислить это преобразование, понадобится выполнить ту самую дорогую операцию взятия по модулю.
    ...
    Все промежуточные вычисления выполняются без этой дорогой операции.`);t(a,v)}}),t(_,n)}});var w=r(j,2);C(w,{children:(_,h)=>{e();var n=R("Умножение Монтгомери");t(_,n)}});var z=r(w,2);b(z,{children:(_,h)=>{var n=ir(),M=l(n);p(M,{children:(m,u)=>{e();var a=mr(),d=r(l(a));o(d,{m:"*"});var v=r(d,2);o(v,{m:"\\cdot"});var s=r(v,2);o(s,{m:"R^{-1}"}),e(),t(m,a)}});var i=r(M,2);o(i,{display:!0,m:`\\overline{a} * \\overline{b} \\defeq \\overline{a \\cdot b}
          = (a \\cdot b) \\cdot R \\bmod M = (\\overline{a} \\cdot \\overline{b}) \\cdot R^{-1} \\bmod M`});var x=r(i,2);p(x,{children:(m,u)=>{e();var a=sr(),d=r(l(a));o(d,{m:"x \\cdot R^{-1} \\bmod M"}),e(3),t(m,a)}}),t(_,n)}});var A=r(z,2);b(A,{children:(_,h)=>{var n=$r(),M=l(n);p(M,{children:(s,f)=>{e();var $=lr(),g=r(l($));o(g,{m:"R^{-1}"});var P=r(g,2);o(P,{m:"M'"}),e(),t(s,$)}});var i=r(M,2);o(i,{display:!0,m:"R \\cdot R^{-1} + M \\cdot M' = 1"});var x=r(i,2);p(x,{children:(s,f)=>{e();var $=cr(),g=r(l($));o(g,{m:"x \\cdot R^{-1}"}),t(s,$)}});var m=r(x,2);o(m,{display:!0,m:`\\align{
          ...
          }`});var u=r(m,2);p(u,{children:(s,f)=>{e();var $=pr(),g=r(l($));o(g,{m:"k"});var P=r(g,2);o(P,{m:"k = \\lfloor x \\cdot M' / R \\rfloor"});var k=r(P,2);o(k,{m:"x \\cdot M' - k \\cdot R = x \\cdot M' \\bmod R"}),e(),t(s,$)}});var a=r(u,2);o(a,{display:!0,m:"x \\cdot R^{-1} \\equiv (x - x \\cdot M' \\bmod R \\cdot M) / R \\pmod{M}"});var d=r(a,2);p(d,{children:(s,f)=>{e();var $=Mr(),g=r(l($));o(g,{m:"x/R < M"});var P=r(g,2);o(P,{m:"x \\cdot M' \\bmod R \\cdot M / R < M"});var k=r(P,2);o(k,{m:"(-M, M)"});var ar=r(k,2);o(ar,{m:"M"}),e(),t(s,$)}});var v=r(d,2);p(v,{children:(s,f)=>{e();var $=R("Получаем уже полный алгоритм усечения");t(s,$)}}),t(_,n)}});var B=r(A,2);y(B,{code:`
const int M, R
...
u32 reduce(const u64 x) {
    ...
    u32 y = (x - m) >> 32;
    return x - m ? y + M : y;
}`});var I=r(G,2);b(I,{children:(_,h)=>{var n=br(),M=l(n);p(M,{children:(m,u)=>{e();var a=hr(),d=r(l(a));o(d,{m:"0"});var v=r(d,2);o(v,{m:"2n-2"});var s=r(v,2);o(s,{m:"M"});var f=r(s,2);q(f,{language:"cpp",c:"return y + M"}),e(),t(m,a)}});var i=r(M,2);p(i,{children:(m,u)=>{e();var a=Rr(),d=r(l(a));q(d,{language:"cpp",c:">> 32"});var v=r(d,2);o(v,{m:"\\lfloor x / R \\rfloor - \\lfloor m / R \\rfloor"});var s=r(v,2);o(s,{m:"(x - m) / R"});var f=r(s,2);o(f,{m:"32"});var $=r(f,2);o($,{m:"x"});var g=r($,2);o(g,{m:"m"});var P=r(g,2);o(P,{m:"m = x \\cdot M \\cdot M' \\equiv x \\pmod R"}),e(),t(m,a)}});var x=r(i,2);p(x,{children:(m,u)=>{e();var a=Pr(),d=r(l(a));o(d,{m:"\\lfloor m / R \\rfloor"});var v=r(d,2);q(v,{language:"cpp",c:"((u64) q * n) >> 32"});var s=r(v,2);o(s,{m:"32"});var f=r(s,2);o(f,{m:"32"});var $=r(f,2);q($,{language:"asm",c:"edx"}),e(),t(m,a)}}),t(_,n)}});var J=r(I,2);y(J,{language:"cpp",code:`u32 reduce(const u64 x) {
    u32 q = static_cast<u32>(x) * Mr;
    u32 m = (static_cast<u64>(q) * M) >> 32;
    return (x >> 32) + M - m;
}`});var K=r(J,2);C(K,{children:(_,h)=>{e();var n=yr(),M=r(l(n));o(M,{m:"R"}),t(_,n)}});var L=r(K,2);b(L,{children:(_,h)=>{var n=Hr(),M=l(n);p(M,{children:(u,a)=>{e();var d=qr(),v=r(l(d));o(v,{m:"M' = M^{-1} \\bmod R"}),e(),t(u,d)}});var i=r(M,2);p(i,{children:(u,a)=>{e();var d=kr(),v=r(l(d));o(v,{m:"R"}),e(),t(u,d)}});var x=r(i,2);o(x,{display:!0,m:"M \\cdot x \\equiv 1 \\pmod{2^k} \\implies M \\cdot x \\cdot (2 - M \\cdot x) \\equiv 1 \\pmod{2^{2k}}"});var m=r(x,2);p(m,{children:(u,a)=>{e();var d=Cr(),v=r(l(d));o(v,{m:"M'"});var s=r(v,2);o(s,{m:"x = 1"});var f=r(s,2);o(f,{m:"M"});var $=r(f,2);o($,{m:"2"});var g=r($,2);o(g,{m:"R"});var P=r(g,2);o(P,{m:"\\log_2 R"}),e(),t(u,d)}}),t(_,n)}});var N=r(L,2);y(N,{code:`function inverse(int M, mod int R):
    Mr = 1
    repeat log2(R) times:
        Mr *= 2 - M * Mr
...
int sum(int *a, int n) {
    ...
    return s;
}`});var Z=r(Y,2);b(Z,{children:(_,h)=>{p(_,{children:(n,M)=>{e();var i=jr(),x=r(l(i));o(x,{m:"\\code{a}[i] < M"});var m=r(x,2);o(m,{m:"s < M"});var u=r(m,2);o(u,{m:"s + \\code{a}[i] < 2M"}),e(),t(n,i)}})}});var er=r(Z,2);y(er,{language:"c",code:`const int M;
int *a, int n;
